...
local function buttoneffect(options)
    pcall(function()
        ...
        options.entered.MouseLeave:Connect(function()
            if options.frame.TextColor3 ~= Color3.fromRGB(157, 171, 182) 
               and options.frame.TextColor3 ~= Color3.fromRGB(234, 239, 246) then
                TweenService:Create(options.frame, TweenInfo.new(0.06, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
...
function Library:Toggle(value)
    ...
    local enabled = (type(value) == "boolean" and value) 
        or game:GetService("CoreGui"):FindFirstChild("Neverlose").Enabled
...
function Library:Window(options)
    ...
    local saveBtn = Instance.new("TextButton") -- Re-enable the Save button
    ...
    SideBar.Parent = Body
    -- Sidebar also quite dark
    SideBar.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
    SideBar.BorderSizePixel = 0
    SideBar.Size = UDim2.new(0, 190, 0, 520)
    ...
    sbLine.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    ...
    TopBar.Name = "TopBar"
    TopBar.Parent = Body
    -- Make top bar visible, so it stands out
    TopBar.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
    TopBar.BorderColor3 = Color3.fromRGB(14, 21, 32)
    TopBar.BorderSizePixel = 0
    TopBar.Position = UDim2.new(0.251, 0, 0, 0)
    TopBar.Size = UDim2.new(0, 562, 0, 50)

    tbLine.Name = "tbLine"
    tbLine.Parent = TopBar
    tbLine.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    ...
    saveLabel.Position = UDim2.new(0.07, 0, 0.1, 0)
    ...
    saveBtn.MouseButton1Click:Connect(function()
        -- Example of hooking up a "Save" callback
        Notify("Neverlose", "Save button clicked!")
    ...
    allPages.Size = UDim2.new(0, 463, 0, 465)
    ...
    tabContainer.Size = UDim2.new(0, 187, 0, 460)
    ...
    function tabsections:TabSection(options)
        ...
        tabSectionLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        ...
        function tabs:Tab(options)
            ...
            tabButton.MouseButton1Click:Connect(function()
                ...
                for i,v in next, SideBar:GetDescendants() do
                    if v:IsA("TextButton") then
                        TweenService:Create(
                            v,
                            TweenInfo.new(0.06, Enum.EasingStyle.Quart, Enum.EasingDirection.In),
            ...
            tabIcon.Position = UDim2.new(0.04, 0, 0.13, 0)
            tabIcon.Size = UDim2.new(0, 21, 0, 21)
            tabIcon.Image = options.icon
            -- You can change accent color if you want (teal, etc.)
            ...
            newPage.Position = UDim2.new(0.021, 0, 0.023, 0)
            ...
            function sections:Section(options)
                ...
                sLine.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
                sLine.BorderSizePixel = 0
                sLine.Position = UDim2.new(0.025, 0, 0.415, 0)
                ...
                function elements:Toggle(options)
                    ...
                    local function PerformToggle()
                        ...
                        TweenService:Create(
                            ...
                            { Position = State and UDim2.new(0.74, 0, 0.5, 0) 
                                         or UDim2.new(0.25, 0, 0.5, 0) }
                        ):Play()
                        TweenService:Create(
                            toggleLabel,
                            TweenInfo.new(0.06, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
                            { TextColor3 = State and Color3.fromRGB(234, 239, 246) 
                                           or Color3.fromRGB(157, 171, 182) }
                        ):Play()
                        TweenService:Create(
                            toggleButton,
                            TweenInfo.new(0.06, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
                            { BackgroundColor3 = State and Color3.fromRGB(2, 162, 243) 
                                                  or Color3.fromRGB(77, 77, 77) }
                        ):Play()
                        TweenService:Create(
                            toggleFrame,
                            TweenInfo.new(0.06, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
                            { BackgroundColor3 = State and Color3.fromRGB(2, 23, 49) 
                                                  or Color3.fromRGB(4, 4, 11) }
                        ):Play()
                    end
